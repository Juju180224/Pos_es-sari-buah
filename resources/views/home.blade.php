                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>
                            ...
                            <strong>
                                {{ optional($best_selling_products->first())->name ?? 'No Data' }}
                            </strong>
                        </p>

                        <p>
                            ⚠ Low Stock Products :
                            <strong>{{ $low_stock_products->count() ?? 0 }}</strong>
                        </p>

                        <p>
                            💰 Income Today :
                            <strong>Rp {{ number_format($income_today ?? 0, 0, ',', '.') }}</strong>
                        </p>
                        ...
                        <p>
                            👥 Customers :
                            <strong>{{ $customers_count ?? 0 }}</strong>
                        </p>
